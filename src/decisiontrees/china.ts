...
export const chinaVisaDecisionTree: VisaDecisionTree = {
  ...
  questions: {
    ...
    q2: {
      ...
      helpText: "Duration affects visa type and eligibility for certain exemptions",
    },
    ...
    q3: {
      ...
      answerType: "single",
      options: [
        { id: "a1", text: "Business meetings/negotiations", nextQuestionId: "q8" },
        { id: "a2", text: "Trade fair/exhibition", nextQuestionId: "q8" },
        { id: "a3", text: "Technology/knowledge transfer or training", nextQuestionId: "q8" },
    ...
    q4: {
      ...
      answerType: "single",
      options: [
        { id: "a1", text: "Regular employment with Chinese company/organization", nextQuestionId: "r3" },
        { id: "a2", text: "Short-term work (under 90 days)", nextQuestionId: "r3" },
        { id: "a3", text: "High-level executive/specialist", nextQuestionId: "r4" },
        { id: "a4", text: "Teaching/education", nextQuestionId: "r5" },
        { id: "a5", text: "Cultural/entertainment performance", nextQuestionId: "r6" },
      ],
      helpText: "Work visa categories depend on the nature and duration of work",
    },
    ...
    q5: {
      ...
      answerType: "single",
      options: [
        { id: "a1", text: "Long-term degree program (6+ months)", nextQuestionId: "r7" },
        { id: "a2", text: "Short-term study (less than 6 months)", nextQuestionId: "r7" },
        { id: "a3", text: "Language program", nextQuestionId: "r7" },
        { id: "a4", text: "Research or academic exchange", nextQuestionId: "r9" },
        { id: "a5", text: "Internship as part of studies", nextQuestionId: "r10" },
      ],
      helpText: "Different educational programs may require different visa types",
    },
    ...
    q6: {
      ...
      answerType: "single",
      options: [
        { id: "a1", text: "Spouse of Chinese citizen/permanent resident", nextQuestionId: "q9" },
        { id: "a2", text: "Parent/child of Chinese citizen/permanent resident", nextQuestionId: "q9" },
        { id: "a3", text: "Other relative of Chinese citizen/permanent resident", nextQuestionId: "r12" },
        { id: "a4", text: "Friend or non-relative", nextQuestionId: "r1" },
      ],
      helpText: "Family relationships affect the type of visa you may be eligible for",
    },
    ...
    q7: {
      ...
      answerType: "single",
      options: [
        { id: "a1", text: "Eligible for visa-free transit (US, Canada, UK, etc.)", nextQuestionId: "r13" },
        { id: "a2", text: "Not eligible for visa-free transit", nextQuestionId: "r1" },
        { id: "a3", text: "Singapore, Brunei, or Japan national", nextQuestionId: "r14" },
      ],
      helpText: "Some nationalities qualify for visa exemptions or simplified procedures",
    },
    ...
    q9: {
      ...
      answerType: "single",
      options: [
        { id: "a1", text: "Short visit (less than 90 days)", nextQuestionId: "r12" },
        { id: "a2", text: "Long-term stay (90+ days)", nextQuestionId: "q10" },
        { id: "a3", text: "Planning to settle permanently", nextQuestionId: "r15" },
      ],
    ...
    q10: {
      ...
      answerType: "single",
      options: [
        { id: "a1", text: "Yes, I have marriage/birth certificates or official documents", nextQuestionId: "r12" },
        { id: "a2", text: "No, I don't have official documentation", nextQuestionId: "r16" },
      ],
      helpText: "Official documentation of family relationships is required for family reunion visas",
    },
    ...
    q11: {
      ...
      answerType: "single",
      options: [
        { id: "a1", text: "Less than 24 hours (without leaving airport)", nextQuestionId: "r17" },
        { id: "a2", text: "24-72 hours (planning to leave airport)", nextQuestionId: "q12" },
        { id: "a3", text: "72-144 hours (planning to leave airport)", nextQuestionId: "q12" },
        { id: "a4", text: "More than 144 hours", nextQuestionId: "r1" },
      ],
      helpText: "Transit duration and whether you'll leave the airport affects visa requirements",
    },
    ...
    q12: {
      ...
      answerType: "single",
      options: [
        { id: "a1", text: "Shanghai, Guangzhou, Beijing, or other 144-hour visa-free transit city", nextQuestionId: "r18" },
        { id: "a2", text: "Chongqing, Xi'an, or other 72-hour visa-free transit city", nextQuestionId: "r19" },
        { id: "a3", text: "City not participating in transit visa exemption program", nextQuestionId: "r1" },
  ...
  results: {
    r1: {
      ...
      processingTime: "4-5 business days (standard); 2-3 business days (express)",
      cost: {
        amount: 140,
        currency: "USD (for US citizens); varies for other nationalities",
      },
      alternativeOptions: ["r2", "r13"],
      applicableCountries: ["Most countries require this visa for tourism in China"],
    },
    ...
    r2: {
      ...
      applicableCountries: ["Most countries require this visa for business activities in China"],
    },
    ...
    r3: {
      ...
      description: 
        "For foreign citizens taking up employment in China.",
      requirements: [
        "Valid passport with at least 6 months validity and blank visa pages",
        "Completed visa application form",
        "Recent passport photo (48mm x 33mm with white background)",
      ...
      applicableCountries: ["Most countries require this visa for work in China"],
    },
    ...
    r4: {
      ...
      applicableCountries: ["All countries, subject to qualification as high-level talent"],
    },
    ...
    r5: {
      ...
      applicableCountries: ["Most countries require this visa for teaching in China"],
    },
    ...
    r6: {
      ...
      applicableCountries: ["Most countries require this visa for performances in China"],
    },
    ...
    r7: {
      ...
      applicableCountries: ["Most countries require this visa for studying in China"],
    },
    ...
    r8: {
      ...
      processingTime: "7-10 business days or longer (requires special approval)",
      cost: {
        amount: 140,
        currency: "USD (for US citizens); varies for other nationalities",
      },
      alternativeOptions: ["r2"],
      applicableCountries: ["Most countries require this visa for journalistic activities in China"],
    },
    ...
    r9: {
      ...
      applicableCountries: ["Most countries require this visa for exchanges and non-commercial visits to China"],
    },
    ...
    r10: {
      ...
      applicableCountries: ["Most countries require this visa for short-term study in China"],
    },
    ...
    r11: {
      ...
      applicableCountries: ["Most countries, though approval for long-term multiple entry visas varies by nationality"],
    },
    ...
    r12: {
      ...
      applicableCountries: ["Most countries, though documentation requirements may vary by nationality"],
    },
    ...
    r15: {
      ...
      applicableCountries: ["All countries, subject to strict qualification requirements"],
    },
    ...
    r17: {
      ...
      applicableCountries: ["Most countries, though policies may vary by nationality"],
    },
